...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  // src/scripts/indexShortener.js
  function indexShortener() {
    return {
      original_url: "",
      isLoading: false,
      result: null,
      async submit() {
        ...
        try {
          ...
          this.result = {
            ...
            short_url: data2.short_url || null
          };
        } catch (error2) {
          this.result = {
            success: false,
    ...
    return {
      ...
      async submit() {
        ...
        try {
          ...
          const data2 = await res.json();
          if (!res.ok) {
            throw new Error(data2.message || "\u767C\u751F\u672A\u77E5\u932F\u8AA4");
          }
          if (data2.success) {
            this.message = data2.message;
            this.messageType = "success";
            this.short_url_result = data2.short_url;
            this.original_url = "";
            this.short_url = "";
            this.password = "";
            this.notes = "";
      ...
      async fetchPageInfo() {
        ...
        try {
          ...
          const data2 = await res.json();
          if (!res.ok) {
            throw new Error(data2.message || "\u6293\u53D6\u8CC7\u8A0A\u5931\u6557");
          }
          this.notes = data2.notes;
        } catch (error2) {
          this.message = error2.message;
        } finally {
  ...
  module_default.data("shortenerForm", shortenerForm);
  module_default.data("indexShortener", indexShortener);
